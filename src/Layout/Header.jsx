...
//           }`}>
//             {/* Glow effect */}
//             <div className="absolute -inset-1 bg-[#20A97B]/5 rounded-xl blur-lg opacity-60 animate-pulse"></div>
//             <div className="absolute -inset-0.5 bg-[#20A97B]/10 rounded-xl blur-md opacity-80"></div>
...
//           <div className="absolute -inset-1 bg-[#20A97B]/15 rounded-xl blur-lg opacity-50"></div>
//           <div className="absolute -inset-0.5 bg-[#20A97B]/10 rounded-xl blur-md opacity-70"></div>
...
//           <div className="absolute -inset-1 bg-[#20A97B]/15 rounded-2xl blur-lg opacity-40"></div>
//           <div className="absolute -inset-0.5 bg-[#20A97B]/10 rounded-2xl blur-md opacity-60"></div>
...
//                 } ${
//                   activeSection === item.id
//                     ? "text-white bg-[#20A97B] shadow-lg shadow-[#20A97B]/30"
//                     : "text-white/80 hover:text-white hover:bg-white/10"
//                 }`}
