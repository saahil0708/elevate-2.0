  ...
  return (
    <footer className="relative bg-gradient-to-b from-black via-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-10">
        <div className="backdrop-blur-lg bg-white/5 rounded-xl border border-white/10 p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <div>
              <h3
                className="text-md font-semibold text-[#20A97B] mb-3"
              ...
              <div className="space-y-2 text-sm">
                <Link 
                  ...
                  className="flex items-center gap-2 text-white hover:text-[#20A97B] transition-colors"
                >
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white hover:text-[#20A97B] transition-all duration-300"
                >
      ...
      {showScrollToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-5 right-5 bg-[#0c5352] hover:bg-[#20A97B] text-white rounded-full p-2 shadow-lg hover:shadow-[0_0_15px_rgba(12,83,82,0.3)] transition-all duration-300 z-50"
