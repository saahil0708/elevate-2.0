    ...
    <svg
      ...
      <defs>
        <linearGradient
          ...
          {hovered && (
            <>
              <stop offset="0%" stopColor="#1cb683" />
              <stop offset="25%" stopColor="#18a576" />
              <stop offset="50%" stopColor="#149d6f" />
              <stop offset="75%" stopColor="#11835c" />
              <stop offset="100%" stopColor="#0d7250" />
            </>
          )}
        </linearGradient>
