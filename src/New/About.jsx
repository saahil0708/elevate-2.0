  ...
  const yearData = {
    ...
    "2024": {
      ...
      description: [
        ...
        "With inspiring leaders like Ashneer Grover and industry pioneers, it brought together culture, startups, and impactful sessions.",
        "Students and professionals from across India participated in engaging competitions, thought-provoking panel discussions, and cultural performances.",
        "Elevate 1.0 was more than just an event — it was the start of a movement fostering creativity, leadership, and community-driven growth.",
