        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch"> {/* Changed to items-stretch */}
            ...
            <div className="space-y-10 flex flex-col">
              <div className="text-center lg:text-left">
                <h2 className="text-5xl font-black bg-gradient-to-r from-[#ffffff] via-[#0c7372] to-[#0c5352] bg-clip-text text-transparent mb-8 tracking-wider">
                  ELEVATE'S YEAR
                </h2>
                <div className="flex flex-wrap justify-center lg:justify-start gap-6 mb-10">
                  {years.map((year) => (
              ...
              {/* Image Display */}
              <div className={`flex-grow transition-all duration-700 ${isLoading ? "opacity-30 scale-95" : "opacity-100 scale-100"}`}>
                <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-2xl overflow-hidden shadow-2xl border border-[#0c5352]/20 h-full flex flex-col">
                  <div className="aspect-video relative flex-grow">
                    {isLoading ? (
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-900 to-gray-800">
                        <div className="w-6 h-6 border-4 border-t-transparent border-[#0c7372] rounded-full animate-spin"></div>
                      </div>
                    ) : (
                      <img
            ...
            {/* Right: About & Stats */}
            <div className={`space-y-10 flex flex-col ${isLoading ? "opacity-30 scale-95" : "opacity-100 scale-100"}`}>
              <div className="flex-grow flex flex-col">
                <h2 className="text-5xl font-black bg-gradient-to-r from-[#ffffff] via-[#0c7372] to-[#0c5352] bg-clip-text text-transparent mb-10 text-center lg:text-left tracking-wider">
                  ABOUT ELEVATE
                </h2>
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm p-8 rounded-2xl border border-[#0c5352]/20 whitespace-pre-line flex-grow">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {Object.entries(currentData.stats).map(([key, value]) => (
                  <div
                    ...
                    className="text-center bg-gradient-to-br from-gray-900/80 to-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 hover:border-[#0c7372]/50 transition-all duration-500 group"
                  >
                    <div className="text-4xl font-black text-[#0c7372] mb-3">
                      {value}
                    </div>
